/**
 * Professional PDF resume renderer using @react-pdf/renderer.
 * Inspired by OpenResume architecture - renders structured resume data
 * into a clean, ATS-friendly Canadian resume format.
 */

import { Document, Page, Text, View, StyleSheet, Font, pdf } from '@react-pdf/renderer'
import type { StructuredResume } from '@/lib/resumeTypes'

// Use built-in fonts for reliability (no registration issues)
Font.register({
  family: 'Helvetica',
  fonts: [
    { src: 'Helvetica' },
...
/**
 * Renders the header section (name, title, contact)
 */
...
/**
 * Renders the professional summary
 */
...
/**
 * Complete professional resume PDF document
 */
...
/**
 * Generate and download a PDF from structured resume data
 */
